...
| DuelScene | BattleCity.DuelScene | staging, card views, HUD, `DuelSession`, `DuelDirector` (the run's duel nodes), `DuelEffects` (the `vfx/` scenes and `assets/audio/sfx` cues behind the §6.4 hooks) |
