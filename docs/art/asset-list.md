...
| 1.5 | Card frame set | Six frames (normal, effect, fusion, ritual, spell, trap), 590 × 860 PNG + layered source; window per `frame.json` | `cards/frames/frame_<type>.png` | review ([director reference revision 4](../requests/card-reference-frames.md)) |
| 1.6 | Card back | Symmetric, one accent colour, 590 × 860 | `cards/frames/card_back.png` | review (#30; shader pending) |
| 1.7 | Attribute icons | 7 reference-derived badges (DARK, LIGHT, EARTH, WATER, FIRE, WIND, DIVINE), 128² PNG with alpha | `cards/icons/attr_<name>.png` | review ([director reference revision 4](../requests/card-reference-frames.md)) |
| 1.8 | Spell/trap glyphs | Spell/trap face badges; equip, continuous, quick-play, counter, field, ritual tooltip-only glyphs; 128² | `cards/icons/st_<name>.png` | review ([director reference revision 4](../requests/card-reference-frames.md)) |
| 1.9 | Level star | 64² | `cards/icons/star.png` | review ([director reference revision 4](../requests/card-reference-frames.md)) |
